...
There is no strict minimum amount of SOL required to run a validator on Solvia.
...
releases at [solvialabs/solvia](https://hub.docker.com/r/solvialabs/solvia).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Solvia](../cli/install-solvia-cli-tools.md) for the current Solvia software release.
...
CUDA is required to make use of the GPU on your system. The provided Solvia
