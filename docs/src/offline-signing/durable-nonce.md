...
> [Full usage documentation](../cli/usage.md#solvia-create-nonce-account)
...
```bash
solvia nonce nonce-keypair.json
```
...
> [Full usage documentation](../cli/usage.md#solvia-get-nonce)
...
```bash
solvia new-nonce nonce-keypair.json
```
...
> [Full usage documentation](../cli/usage.md#solvia-new-nonce)
...
```bash
solvia nonce-account nonce-keypair.json
```
...
> [Full usage documentation](../cli/usage.md#solvia-nonce-account)
...
> [Full usage documentation](../cli/usage.md#solvia-withdraw-from-nonce-account)
...
```bash
solvia authorize-nonce-account nonce-keypair.json nonce-authority.json
```
...
> [Full usage documentation](../cli/usage.md#solvia-authorize-nonce-account)
...
```bash
$ solvia create-nonce-account -k alice.json nonce.json 0.1
...
```bash
$ solvia pay -k alice.json --blockhash expiredDTaxfagttWjQweib42b6ZHADSx94Tw8gHx3W7 bob.json 0.01
...
```bash
$ solvia pay -k alice.json --blockhash F7vmkY3DTaxfagttWjQweib42b6ZHADSx94Tw8gHx3W7 --nonce nonce.json bob.json 0.01
