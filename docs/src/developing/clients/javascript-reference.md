...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Connection.html)

Connection is used to interact with the [Solvia JSON RPC](https://docs.solvia.com/developing/clients/jsonrpc-api). You can use Connection to confirm transactions, get account info, and more.
...
The above example shows only a few of the methods on Connection. Please see the [source generated docs](https://solvia-labs.github.io/solvia-web3.js/classes/Connection.html) for the full list.

### Transaction

[SourceDocumentation](https://solvia-labs.github.io/solvia-web3.js/classes/Transaction.html)
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Keypair.html)
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@solvia/web3.js` in transactions, keypairs, and programs. You require publickey when listing each account in a transaction and as a general identifier on Solvia.
...
[SourceDocumentation](https://solvia-labs.github.io/solvia-web3.js/classes/SystemProgram.html)
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Message.html)

Message is used as another way to construct transactions. You can construct a message using the accounts, header, instructions, and recentBlockhash that are a part of a transaction. A [Transaction](https://solvia-labs.github.io/solvia-web3.js/classes/Transaction.html) is a Message plus the list of required signatures required to execute the transaction.
...
[SourceDocumentation](https://solvia-labs.github.io/solvia-web3.js/classes/Struct.html)
...
import {Struct} from '@solvia/web3.js';
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Enum.html)

The Enum class is used to represent a Rust compatible Enum in javascript. The enum will just be a string representation if logged but can be properly encoded/decoded when used in conjunction with [Struct](https://solvia-labs.github.io/solvia-web3.js/classes/Struct.html). This class is only compatible with Borsch encoded Rust enumerations.
...
Web3:
```javascript
import {Enum} from '@solvia/web3.js';
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/NonceAccount.html)
...
[SourceDocumentation](https://solvia-labs.github.io/solvia-web3.js/classes/VoteAccount.html)
...
[SourceDocumentation](https://solvia-labs.github.io/solvia-web3.js/classes/StakeProgram.html)
...
[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Authorized.html)
...
You can find more usage of the `Authorized` object under [`StakeProgram`](https://solvia-labs.github.io/solvia-web3.js/classes/StakeProgram.html)

### Lockup

[Source Documentation](https://solvia-labs.github.io/solvia-web3.js/classes/Lockup.html)

Lockup is used in conjunction with the [StakeProgram](https://solvia-labs.github.io/solvia-web3.js/classes/StakeProgram.html) to create an account. The Lockup is used to determine how long the stake will be locked, or unable to be retrieved. If the Lockup is set to 0 for both epoch and the Unix timestamp, the lockup will be disabled for the stake account.

#### Example Usage

```javascript
const {Authorized, Keypair, Lockup, StakeProgram} = require("@solvia/web3.js");
...
See [StakeProgram](https://solvia-labs.github.io/solvia-web3.js/classes/StakeProgram.html) for more.
